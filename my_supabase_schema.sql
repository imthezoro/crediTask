...
CREATE POLICY "Users can view participants in their chats" ON "public"."chat_participants" FOR SELECT TO "authenticated" USING (("chat_room_id" IN ( SELECT "chat_participants_1"."chat_room_id"
...
ALTER TABLE "public"."auto_assignment_timers" ENABLE ROW LEVEL SECURITY;
